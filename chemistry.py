...
def make_periodic_table():
    """Return a dictionary of chemical elements.
    Key = symbol
    Value = [name, atomic_mass]
    """
        # 1. symbol: [name, atomic_mass]
    periodic_table_dict = {
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    """Compute total molar mass from a parsed formula list."""
...
def main():
    ...
    # 2.Ask user for formula and validation
    while True:
        ...
        try:
            ...
            print("ERROR: Invalid formula. Please try again.\n")
